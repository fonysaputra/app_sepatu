          ...
          <View style={styles.TextRating}>
            <View style={{ flex: 3 }}>
              ...
              <TouchableOpacity
                activeOpacity={0.8}
                onPress={() => {
                  props.navigation.navigate("Detailsolsepatu", {
                    solsepatu: dataRatings.solsepatu,
                    nama: dataRatings.nama,
                    alamat: dataRatings.alamat,
                    foto: dataRatings.foto,

                    no_telp: dataRatings.no_telp
                  });
                }}
                style={{
                  alignSelf: "flex-end",
...
export default withNavigation(RatingTerbaik);
