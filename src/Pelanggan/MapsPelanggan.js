...
class MapsPelanggan extends React.Component {
                ...
                <Marker
                  ...
                  onPress={() => {
                    this.props.navigation.navigate("Detailsolsepatu", {
                      id_solsepatu: marker.id_solsepatu,
                      nama: marker.nama,
                      alamat: marker.alamat,
                      foto: marker.foto,
                      no_telp: marker.no_telp
                    });
                  }}
...
export default connect(mapStateToProps)(MapsPelanggan);
